...
public final class ProgressBarBinding implements ViewBinding {
  ...
  private ProgressBarBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static ProgressBarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProgressBarBinding((ConstraintLayout) rootView, progressBar, tvProgressText);
    }
